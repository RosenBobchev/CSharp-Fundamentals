...
namespace _10.TheHeiganDance
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            string lastSpellUsedOnPlayer = string.Empty;
            ...
            while (true)
            {
                ...
                if (IsInDanger(playerPosition, row, col))
                {
                    ...
                    {
                        hasPlague = true;
                        lastSpellUsedOnPlayer = "Plague Cloud";
                    }
                    else
                    {
                        lastSpellUsedOnPlayer = "Eruption";
                    }
                }
            ...
            if (player <= 0)
            {
                Console.WriteLine($"Player: Killed by {lastSpellUsedOnPlayer}");
            }
            else
            {
