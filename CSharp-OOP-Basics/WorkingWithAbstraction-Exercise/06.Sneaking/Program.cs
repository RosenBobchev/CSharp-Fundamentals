...
public class Program
{
    ...
    static void Main(string[] args)
    {
        ...
        for (int i = 0; i < moves.Length; i++)
        {
            ...
            IsSamAlive(samPosition, getEnemy);
            ...
            {
                CheckForNikoladze(getEnemy);
            }
        }
    }

    private static void IsSamAlive(int[] samPosition, int[] getEnemy)
    {
    ...
    private static void CheckForNikoladze(int[] getEnemy)
    {
    ...
    private static int MovingGuards(int row, int col)
    {
        if (room[row][col] == 'b')
        {
