...
public abstract class Soldier : ISoldier
{
    ...
    private const int SoldierRegenerationValue = 10;
    ...
    public virtual void Regenerate() => this.Endurance += this.Age + SoldierRegenerationValue;

    public IDictionary<string, IAmmunition> InitlizeWeapons()
    {
